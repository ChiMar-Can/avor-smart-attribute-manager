...
MODULES = [
    ...
    "avor_smart_attribute_manager.analysis.attribute_mapping",
    "avor_smart_attribute_manager.analysis.value_comparison",
    "avor_smart_attribute_manager.analysis.online_analyzer",
    ...
    "avor_smart_attribute_manager.datasources.provider",
    "avor_smart_attribute_manager.datasources.mouser",
    "avor_smart_attribute_manager.datasources.cache",
    "avor_smart_attribute_manager.datasources.normalization",
    "avor_smart_attribute_manager.models.online",
